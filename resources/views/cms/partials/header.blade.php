<header class="main-header">
  ...
  <a href="{{ route('cms.dashboard') }}" class="logo">
    ...
    <span class="logo-lg"><b>Admin</b>{{ strtoupper(setting('admin.title')) }}</span>
  </a>
            ...
            <li>
              ...
              <ul class="menu">
                ...
                <li>
                  <a href="#">
                    <div class="pull-left">
                      <img src="{{ asset('cms/dist/assets/images/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                    </div>
                    <h4>
                      AdminKOTEKS Design Team
                ...
                <li>
                  <a href="#">
                    <div class="pull-left">
                      <img src="{{ asset('cms/dist/assets/images/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                    </div>
                    <h4>
                      Developers
