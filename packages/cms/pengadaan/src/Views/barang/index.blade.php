        ...
        <div class="box box-primary">
          <div class="box-header">
            ...
            <div class="btn-group pull-right m-b-10">
              ...
              <a class="btn btn-primary" href="{{ route('cms.barang.create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>   
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
      ...
      $(document).ready(function(){		  	
        ...
        var settings = {
          ...
          columns: [
            ...
            { data:'bahan', orderable:false },
            { data:'spesifikasi'},
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-primary btn-space" href="'+ ADMIN_URL + '/barang/edit/' + data.id +'" role="button">Edit</a>';
              var deleteButton = '<a class="btn btn-danger deleteDialog" href="'+ ADMIN_URL + '/barang/list/delete/' + data.id +'" data-title="Laporan" role="button">Delete</a>';
          ...
          $.ajax({
            ...
            success: function(result, status, xhr){                
                if(result.data){                    
                  ...
                  saveAs(new Blob([s2ab(wbout)],{type:"application/octet-stream"}), 'barang.xlsx');
                }else{
                    alert('empty data')
                }
            },
