		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<!-- /.box-header -->
					...
					<!-- form start -->
					{!! Form::open(['route' => ['cms.barang.update', 'id' => $barang->id], 'role'=>'form', 'autocomplete'=>'off']) !!}	
						<div class="box-body">
							<div class="form-group {{ ($errors->first('kode_barang')) ? 'has-error' : '' }}">
								<label for="fkode_barang">Kode barang</label>
								<textarea class="form-control" placeholder="No. Laporan" id="fkode_barang" name="kode_barang" required>{{ $barang->kode_barang }}</textarea>
							...
							<div class="form-group {{ ($errors->first('nama')) ? 'has-error' : '' }}">
								...
								<textarea class="form-control" placeholder="No. Laporan" id="fnama" name="nama" required>{{ $barang->nama }}</textarea>
								@if($errors->has('nama'))										
							...
							<div class="form-group {{ ($errors->first('kategory')) ? 'has-error' : '' }}">
								...
								<textarea class="form-control" placeholder="No. Laporan" id="fkategory" name="kategory" required>{{ $barang->kategory }}</textarea>
							...
							<div class="form-group {{ ($errors->first('merk')) ? 'has-error' : '' }}">
								...
								<textarea class="form-control" placeholder="No. Laporan" id="fmerk" name="merk" required>{{ $barang->merk }}</textarea>
								@if($errors->has('merk'))										
							...
							<div class="form-group {{ ($errors->first('bahan')) ? 'has-error' : '' }}">
								...
								<textarea class="form-control" placeholder="No. Laporan" id="fbahan" name="bahan" required>{{ $barang->bahan }}</textarea>
								@if($errors->has('bahan'))										
							...
							<div class="form-group {{ ($errors->first('spesifikasi')) ? 'has-error' : '' }}">
								...
								<textarea class="form-control" placeholder="No. Laporan" id="fspesifikasi" name="spesifikasi" required>{{ $barang->spesifikasi }}</textarea>
