							...
							<div class="wrap-item-pengajuan">
								...
								<div class="box-body item-pengajuan" id="item-pengajuan1">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="fspesifikasi_barang" name="pengadaan[1][spesifikasi_barang]" value="" required>
									</div>

									<div class="form-group">
										<label for="furaian_barang">Uraian Barang</label>
										<input type="text" class="form-control" id="furaian_barang" name="pengadaan[1][uraian_barang]" value="" required>
									</div>

									<div class="form-group">
										<label for="fketerangan">Keterangan</label>
										<textarea class="form-control" placeholder="Keteranga" id="fketerangan" name="pengadaan[1][keterangan]" required></textarea>
									</div>
