			...
			{!! Form::open(['route' => ['cms.pengadaan.update', 'id'=>$pengadaan->id], 'role'=>'form', 'autocomplete'=>'off']) !!}	
				<div class="box-body">
					...
					<div class="form-group {{ ($errors->first('tgl_pengajuan')) ? 'has-error' : '' }}">
						...
						<input type="readonly" class="form-control datepicker" id="ftgl_pengajuan" name="tgl_pengajuan" value="{{ $pengadaan->pengajuan }}" required readonly="true">
					...
					<div class="wrap-item-pengajuan">
						...
						<div class="box-body item-pengajuan" id="item-pengajuan{{ $item_key }}">
							<div class="form-group">
								...
								<input type="readonly" class="form-control" id="fnama_barang" name="pengadaan[{{ $item_key }}][nama_barang]" value="{{ $item->nama_barang }}" required readonly="true">
							</div>

							<div class="form-group">
								<label for="fspesifikasi_barang">Spesifikasi Barang</label>
								<input type="readonly" class="form-control" id="fspesifikasi_barang" name="pengadaan[{{ $item_key }}][spesifikasi_barang]" value="{{ $item->spesifikasi_barang }}" required readonly="true">
							</div>

							<div class="form-group">
								<label for="furaian_barang">Uraian Barang</label>
								<input type="readonly" class="form-control" id="furaian_barang" name="pengadaan[{{ $item_key }}][uraian_barang]" value="{{ $item->uraian_barang }}" required readonly="true">
							</div>

							<div class="form-group">
								<label for="fketerangan">Keterangan</label>
								<textarea class="form-control" placeholder="Keterangan" id="fketerangan" name="pengadaan[{{ $item_key }}][keterangan]" required readonly="true">{{ $item->keterangan }}</textarea>
							</div>
						</div>
						@endforeach
						@endif
