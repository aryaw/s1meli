							...
							<div class="wrap-item-pengajuan">
								...
								<div class="box-body item-pengajuan" id="item-pengajuan1">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="fspesifikasi_barang" name="penerimaan[1][spesifikasi_barang]" value="" required>
									</div>

									<div class="form-group">
										<label for="furaian_barang">Uraian Barang</label>
										<input type="text" class="form-control" id="furaian_barang" name="penerimaan[1][uraian_barang]" value="" required>
									</div>

									<div class="form-group">
										<label for="fketerangan">Keterangan</label>
										<textarea class="form-control" placeholder="Keteranga" id="fketerangan" name="penerimaan[1][keterangan]" required></textarea>
									</div>
    ...
    $(document).ready(function(){
      	$('body').on('click', '.add-item', function(evt) {
		  	...
		  	_html = '<div class="box-body item-pengajuan" id="item-pengajuan'+_new_item_row+'">'+
				...
				'<div class="form-group">'+
					'<label for="fspesifikasi_barang">Spesifikasi Barang</label>'+
					'<input type="text" class="form-control" id="fspesifikasi_barang" name="penerimaan['+_new_item_row+'][spesifikasi_barang]" value="" required>'+
				'</div>'+
				'<div class="form-group">'+
					'<label for="furaian_barang">Uraian Barang</label>'+
					'<input type="text" class="form-control" id="furaian_barang" name="penerimaan['+_new_item_row+'][uraian_barang]" value="" required>'+
				'</div>'+
				'<div class="form-group">'+
					'<label for="fketerangan">Keterangan</label>'+
					'<textarea class="form-control" placeholder="Keteranga" id="fketerangan" name="penerimaan['+_new_item_row+'][keterangan]" required></textarea>'+
				'</div>'+
				'<div class="form-group">'+
