							...
							<div class="wrap-item-pengajuan">
								...
								<div class="box-body item-pengajuan" id="item-pengajuan1">
									...
									<div class="form-group">
										...
										<textarea class="form-control" placeholder="Spesifikasi Barang" id="fspesifikasi_barang" name="perbaikan[1][spesifikasi_barang]" required></textarea>
									</div>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="fqty" name="perbaikan[1][qty]" value="">
									</div>

									<div class="form-group">
										<label for="furaian_barang">Satuan</label>
										<input type="text" class="form-control" id="fsatuan" name="perbaikan[1][satuan]" value="">
									</div>

									<div class="form-group">
										<label for="fketerangan">Keterangan</label>
										<textarea class="form-control" placeholder="Keterangan" id="fketerangan" name="perbaikan[1][keterangan]"></textarea>
									</div>
