      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <div class="box-header">
            <h3 class="box-title"></h3>
            <div class="btn-group pull-right m-b-10">
            	<a class="btn btn-primary" href="{{ route('cms.user.create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <div class="clearfix"></div>
          </div>
          <!-- /.box-header -->
        ...
        var settings = {
          ...
          columns: [
            ...
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-primary btn-space" href="'+ ADMIN_URL + '/user/edit/' + data.id +'" admin="button">Edit</a>';
              var editPasswdButton = '<a class="btn btn-primary btn-space" href="'+ ADMIN_URL + '/user/editpasswd/' + data.id +'" admin="button">Edit Password</a>';
              var deleteButton = '<a class="btn btn-danger deleteDialog" href="'+ ADMIN_URL + '/user/list/delete/' + data.id +'" data-title="'+data.name+'" role="button">Delete</a>';
