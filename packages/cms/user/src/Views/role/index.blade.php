          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <div class="btn-group pull-right m-b-10">
              	<a class="btn btn-primary" href="{{ route('cms.role.create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>
              </div>
        ...
        var settings = {
          ...
          columns: [
            ...
            { data:null, orderable: false, render:function(data, type, row, meta){	               		
              var editButton = '<a class="btn btn-primary btn-space" href="'+ ADMIN_URL + '/user/role/edit/' + data.id +'" role="button">Edit</a>';
              var deleteButton = '<a class="btn btn-danger deleteDialog" href="#" data-title="'+data.name+'" data-redirect="'+ ADMIN_URL + '/user/role/delete/' + data.id +'" role="button">Delete</a>';
